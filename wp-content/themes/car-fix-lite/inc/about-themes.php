...
<div class="gt-right">			
        <div>				
            <a href="http://www.gracethemesdemo.com/car-fix/" target="_blank"><?php esc_html_e('Live Demo', 'car-fix-lite'); ?></a> |          
            <a href="http://www.gracethemesdemo.com/documentation/car-fix/#homepage-lite" target="_blank"><?php esc_html_e('Documentation', 'car-fix-lite'); ?></a>
        </div>		
</div><!-- .gt-right-->
<div class="clear"></div>
</div><!-- .wrap-GT -->
