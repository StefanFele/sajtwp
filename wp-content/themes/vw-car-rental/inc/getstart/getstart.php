...
function vw_car_rental_admin_theme_style() {
   wp_enqueue_style( 'vw-car-rental-font', vw_car_rental_admin_font_url(), array() );
   wp_enqueue_style('vw-car-rental-custom-admin-style', get_template_directory_uri() . '/inc/getstart/getstart.css');
   wp_enqueue_script('vw-car-rental-tabs', get_template_directory_uri() . '/inc/getstart/js/tab.js');
}
add_action('admin_enqueue_scripts', 'vw_car_rental_admin_theme_style');

// Theme Font URL
function vw_car_rental_admin_font_url() {
	$font_url = '';
	$font_family = array();
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_car_rental_open_tab(event, 'theme_lite')"><?php esc_html_e( 'Getting Started', 'vw-car-rental' ); ?></button>		  
